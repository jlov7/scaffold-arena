  ...
  return (
    <div className="lab-shell">
        ...
        <div className="flex min-h-16 items-center gap-3 px-3 sm:px-4">
          ...
          <div className="hidden items-center gap-2 lg:flex">
            ...
            <StatusBadge tone={hasApiToken ? 'success' : 'warning'}>
              {hasApiToken ? 'Token ready' : 'Token needed'}
            </StatusBadge>
          </div>
      ...
      <main
        ...
        role="main"
        tabIndex={-1}
        className="lab-stage min-h-0 overflow-x-hidden px-4 pb-36 pt-5 sm:px-6 sm:py-5 lg:px-8"
      >
      ...
      <div
        className="fixed inset-x-0 bottom-[4.35rem] z-40 border-t border-border bg-bg-primary/92 px-3 py-2 backdrop-blur sm:hidden"
