...
This ADR records an earlier migration and rollback plan. Protocol-v1 Workbench boundaries are now governed by ADR 007; retain this ADR as decision history, not current operational guidance.
